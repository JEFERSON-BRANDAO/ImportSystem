<%@ Page Title="Formulario Maritimo" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="FormularioMaritimo.aspx.cs" Inherits="ImportSystem.FormularioMaritimo" %>
                    ...
                    <fieldset class="bordaFieldset" style="width: 856px; margin: 5px; padding: 17px;
                        ...
                        <div class="blocoGrupoCampos" style="border-bottom-color: transparent; border-bottom-width: medium;
                            ...
                            <fieldset style="width: 220px; display: block; float: left; margin: 10px;">
                                <legend>Marítimo<label style="font-size: x-small; color: Red;">
                                </label>
                                </legend>
                        ...
                        <div class="blocoGrupoCampos" style="margin-left: 15px;">
                            <rsweb:ReportViewer ID="RelatorioMaritimo" runat="server" Height="300px" Width="720px"
                                Font-Names="Verdana" Font-Size="8pt" InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana"
                                WaitMessageFont-Size="14pt" OnLoad="RelatorioMaritimo_Load">
                                <LocalReport ReportPath="vazio.rdlc">
                                </LocalReport>
                            </rsweb:ReportViewer>
                            <asp:ObjectDataSource ID="ObjectDataSourceMaritimo" runat="server" SelectMethod="ListaFormularioMaritimo"
                                TypeName="Classes.Relatorios">
                                <SelectParameters>
                                    <%--  <asp:ControlParameter ControlID="cboMaterial" Name="IdItem" PropertyName="SelectedValue"
                                    Type="String" />--%>
                                    <asp:RouteParameter Name="IdMaritimo" RouteKey="id" Type="String" />
                                </SelectParameters>
