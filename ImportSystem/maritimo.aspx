<%@ Page Title="Sea Shipment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="maritimo.aspx.cs" Inherits="ImportSystem.maritimo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    function s() {
        var t = document.getElementById("<%=GridMaritimo.ClientID%>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel ID="UpdatePanelMaritimo" runat="server">
        <ContentTemplate>
            <asp:Panel ID="PanelUsuario" Width="920px" Height="630px" runat="server" CssClass="intropanel"
                ScrollBars="None">
                <div class="blocoGrupoCampos" style="margin-left: 18px; width: 800px;">
                    <fieldset class="bordaFieldset" style="width: 857px;">
                ...
                <div class="blocoGrupoCampos" style="margin-left: 18px; width: 750px">
                    ...
                    <fieldset class="bordaFieldset" style="width: 857px; height: 318px">
                        <legend>Lista de Importação Marítima</legend>
                        <div id="DivRoot" align="left">
                            <div style="overflow: hidden;" id="DivHeaderRow">
                            </div>
                            <div style="overflow: scroll;" onscroll="OnScrollDiv(this)" id="DivMainContent">
                                <asp:GridView ID="GridMaritimo" Width="100%"  runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                    PageSize="8" CellPadding="4" DataKeyNames="id" OnRowCommand="GridMaritimo_RowCommand"
                                    BackColor="#003399" BorderColor="#003399" BorderStyle="None" BorderWidth="1px">
                                ...
                                <SortedDescendingHeaderStyle BackColor="#002876" />--%>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Pwce">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLinkPwce" ToolTip="Editar" Text='<%# Eval("pwce") %>' runat="server"
                                                    NavigateUrl='<%# "novoMaritimo/" + Eval("Id") %>' Font-Underline="True"></asp:HyperLink>
                                            </ItemTemplate>
                                        ...
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLinkPedido" ToolTip="Editar" Text='<%# Eval("pedido") %>'
                                                runat="server" NavigateUrl='<%# "novoMaritimo?id=" + Eval("Id") %>' Font-Underline="True"></asp:HyperLink>
                                        </ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="nr_container" HeaderText="N.Container">
                                            <ItemStyle HorizontalAlign="Center" Width="30px" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="bl" HeaderText="B/L">
                                            <ItemStyle HorizontalAlign="Center" Width="30px" />
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="liberacao_irf" HeaderText="Liberação IRF" DataFormatString="{0:dd/MM/yyyy}">
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="HyperLinkDemurrage" runat="server" NavigateUrl='<%# "demurrage?id=" + Eval("Id") %>'
                                                    ForeColor="#CC3300" Font-Underline="True">HplDemurrage</asp:HyperLink>
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" Font-Underline="true" Width="50px" />
                                        </asp:TemplateField>
                                        <%--   
                                    <asp:TemplateField HeaderText="ETA MAO" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label ID="lbEta_MAO" runat="server" Text='<%# Eval("ETA_MAO") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Font-Underline="False" />
                                    </asp:TemplateField>--%>
                                    </Columns>
                                    ...
                                    <FooterStyle BackColor="White" ForeColor="#000066" CssClass="GVFixedFooter" />
                                    <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" CssClass="GVFixedHeader" />
                        ...
                        <asp:Panel ID="Panel1" runat="server" CssClass="modalPopup" Style="display: table">
                            <div class="modalPopup" style="width: 775px; overflow-y: scroll; height: 200px">
                                        ...
                                        <td>
                                            ...
                                            <asp:GridView ID="GridInformacao" runat="server" Width="800px" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="etd_hk" HeaderText="Etd HK" DataFormatString="{0:dd/MM/yyyy}">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="eta_mao" HeaderText="Eta MAO" DataFormatString="{0:dd/MM/yyyy}">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    ...
                                                    <asp:BoundField DataField="eta_Foxconn" HeaderText="Eta Foxconn" DataFormatString="{0:dd/MM/yyyy}">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="nr_container" HeaderText="Nr.Container">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="qtd_pallets" HeaderText="Qtd Pallet Comp.">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="data_devolucao" HeaderText="Dt.Devolução" DataFormatString="{0:dd/MM/yyyy}">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="Remarks" HeaderText="remarks">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="transp_local" HeaderText="Transp.Local">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="bls_oceanus" HeaderText="BL's Oceanus">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="dta" HeaderText="Dta">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="produto" HeaderText="Prod.Suframa">
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                </Columns>
                        ...
                        <asp:GridView ID="GridExcel" Width="855px" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="fob_usd" HeaderText="FOB USD">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="etd_hk" HeaderText="ETD HK" NullDisplayText="-" DataFormatString="{0:dd/MM/yyyy}">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="data" HeaderText="DATA" NullDisplayText="-" DataFormatString="{0:dd/MM/yyyy}">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="nr_container" HeaderText="NR.CONTAINER">
                                ...
                                <asp:BoundField DataField="qtd_pallets" HeaderText="QTD PALLETS">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="data_devolucao" HeaderText="DEVOLUÇÃO DEPOT" NullDisplayText="-"
                                    DataFormatString="{0:dd/MM/yyyy}">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                ...
                                <asp:BoundField DataField="bls_oceanus" HeaderText="BLS OCEANUS" NullDisplayText="-">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="dta" HeaderText="DTA" NullDisplayText="-">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:BoundField DataField="liberacao_irf" HeaderText="LIBERAÇÃO IRF" NullDisplayText="-"
                                    DataFormatString="{0:dd/MM/yyyy}">
                                    <ItemStyle HorizontalAlign="Center" />
                                    <HeaderStyle HorizontalAlign="Center" />
                                </asp:BoundField>
