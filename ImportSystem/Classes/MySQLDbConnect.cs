    ...
    public class MySQLDbConnect
    {
        ...
        public bool Conectar()
        {
            try
            {
                ...
                string _connectionString = "server=" + ConfigurationManager.AppSettings["IP_SERVIDOR"].ToString() + ";uid=" + cript.Descriptografar(ConfigurationManager.AppSettings["USUARIO"].ToString()) + ";pwd=" + cript.Descriptografar(ConfigurationManager.AppSettings["SENHA"].ToString()) + ";database=" + cript.Descriptografar(ConfigurationManager.AppSettings["DATABASE"].ToString());
